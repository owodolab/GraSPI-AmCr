...
function [values,descriptornames,LimPhiSolv_FilmMean,LimPhiAir_Film,PercoThresElec,PercoThresHoles]=VisualizeDEscriptorsAuto(inputFile,NameFolderGraspi,NameWorkflowSave,NameFileSave,TimeStepChoice,hhh,numworkflow,PostParam,ResultsSaveFile)
%load data
